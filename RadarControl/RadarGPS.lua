function radarPosToXYZ(selfX,selfY,selfZ,eulerX,eulerY,eulerZ,targetHeading,targetElevation,targetDistance)
...
function XYZToHeadingElevationDistance(selfX,selfY,selfZ,eulerX,eulerY,eulerZ,targetX,targetY,targetZ)
